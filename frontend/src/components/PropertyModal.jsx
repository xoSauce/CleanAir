        ...
        <div className="modal-inner" onClick={this.stop}>
          ...
          <h3>Property Type</h3>
            <div className="input-group-wrapper">
              <div className="input-group">
                <from>
                  <input type="radio" name="type" onclick="check(this.value)" value="Houses"/><label>&nbsp;&nbsp;Houses</label>
                  &nbsp;&nbsp;<input type="radio" name="type" onclick="check(this.value)" value="Flats"/><label>&nbsp;&nbsp;Flats</label>
                </from>
              </div> 
            </div>
          <hr/>
